...
HELP_TEXT = f"""🌹 **ROSE Music Bot** Commands:
🎵 /play, /vplay, /anonplay, /queue, /pause, /resume, /stop
🛡 Admin: /ban, /unban, /mute, /unmute
👑 Owner: /broadcast, /pmcast, /stats"""
...
async def help_cmd(client, message):
    ...
    await send_log(client, f"❓ /help by {message.from_user.mention} in {message.chat.title if message.chat.id else 'PM'} [{message.chat.id if message.chat.id else message.from_user.id}]")
